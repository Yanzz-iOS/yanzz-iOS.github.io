...
<head>
  ...
  <title>Bot Command Viewer</title>
...
<script>
  ...
  const commandsData = [
    ...
    { category: 'Server', syntax: '≈userinfo' },
    { category: 'Server', syntax: '≈avatar' },
    { category: 'Server', syntax: 'info≈server' },
    { category: 'Server', syntax: '≈afk' },
    { category: 'Server', syntax: '≈qafk' },
    { category: 'Server', syntax: 'icons≈server' },
    { category: 'Server', syntax: 'profile≈user' },
    { category: 'Server', syntax: '≈emulators' },
    { category: 'Server', syntax: '≈pokémon' },
    { category: 'Server', syntax: '≈fget' },
    { category: 'Server', syntax: 'ran≈pokémon' },
    { category: 'Server', syntax: '≈purge' },
    { category: 'Server', syntax: 'add≈role' },
    { category: 'Server', syntax: 'role≈remove' },
    { category: 'Server', syntax: '≈setverify' },
    { category: 'Server', syntax: '≈ship' },
    { category: 'Server', syntax: 'add≈emoji' },
    { category: 'Server', syntax: '≈tiktok' },
    { category: 'Server', syntax: '≈ytdow' },
    { category: 'Server', syntax: '≈joke' },
    { category: 'Server', syntax: '≈meme' },
    { category: 'Server', syntax: '≈move' },
    { category: 'Server', syntax: '≈massban' },
    { category: 'Server', syntax: '≈roulette' },
    { category: 'Server', syntax: '≈gag' },
    { category: 'Anime', syntax: 's≈anime' },
    { category: 'Anime', syntax: 'r≈anime' },
    { category: 'Anime', syntax: 'i≈anime' },
    { category: 'Bypass Executor', syntax: '/Bypass' },
    { category: 'Bypass Executor', syntax: '/codex' },
    { category: 'Roblox', syntax: '≈search' },
    { category: 'Roblox', syntax: '≈version' },
    { category: 'Roblox', syntax: 'r≈avatar' },
    { category: 'Roblox', syntax: '≈tax' },
    { category: 'AI', syntax: '≈video' },
    { category: 'AI', syntax: '≈picture' },
    { category: 'AI', syntax: '≈owoify' },
    { category: 'AI', syntax: '≈utctime' },
    { category: 'AI', syntax: '≈tts' },
    { category: 'AI', syntax: '≈playground' },
    { category: 'AI', syntax: '≈pixartsigma' },
    { category: 'AI', syntax: 'ai≈leonardo' },
    { category: 'Nsfw', syntax: '≈nsfw' },
    { category: 'Nsfw', syntax: '≈nsfw image' },
    { category: 'Nsfw', syntax: '≈awoo' },
    { category: 'Nsfw', syntax: '≈pat' },
    { category: 'Nsfw', syntax: '≈dance' },
    { category: 'Music', syntax: '≈play' },
  ...
  // Scroll to category on command click
